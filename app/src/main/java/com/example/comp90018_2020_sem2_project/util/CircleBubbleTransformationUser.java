...
public class CircleBubbleTransformationUser implements com.squareup.picasso.Transformation {
    ...
    public CircleBubbleTransformationUser(Context context, Boolean userType){
